...
public class ProductManager {
    ...
    private static HashMap<Integer,Product> productList = new HashMap <>();
    ...
    private static void addProduct() {
        ...
        productList.put(id, new Product(id, name, price));
    ...
    private static void filterProducts() {
        ...
        productList.values().stream()
                .filter(product -> product.getPrice() > 100)
                .forEach(System.out::println);
    }

    private static void totalValue() {
        double total = productList.values().stream()
